...
public class AnnotationDescription implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		return species.equals(other.getSpecies()) && curator.equals(other.getCurator())
	...
	public String toString() {
		...
		sb.append("Data Source = ").append(curator).append(", Type = ").
                        append(annotationType).append(", Species = ").
                        append(species);
